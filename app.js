(() => {
  ...
  assetStrip.addEventListener("pointerdown",event=>{if(stripGesture)return;assetStrip.setPointerCapture?.(event.pointerId);stripGesture={id:event.pointerId,startX:event.clientX,startScroll:routeViewport.scrollLeft,moved:false};});
